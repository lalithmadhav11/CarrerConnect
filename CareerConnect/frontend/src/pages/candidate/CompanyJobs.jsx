...
const CandidateCompanyJobs = () => {
  ...
  // Filter jobs - candidates only see active jobs
          ...
          <div className="layout-content-container flex flex-col max-w-[960px] flex-1">
            ...
            <div className="pb-3">
              <div className="flex border-b border-[#d5dce2] px-4 gap-8">
                <button
                  className="flex flex-col items-center justify-center border-b-[3px] border-b-transparent text-[#5d7589] pb-[13px] pt-4"
                  onClick={() => navigate(`/candidate/company/${companyId}`)}
                >
                  <p className="text-[#5d7589] text-sm font-bold leading-normal tracking-[0.015em]">
                    About
                  </p>
                </button>
                <button className="flex flex-col items-center justify-center border-b-[3px] border-b-[#4485ba] text-[#111518] pb-[13px] pt-4">
                  <p className="text-[#111518] text-sm font-bold leading-normal tracking-[0.015em]">
                    Jobs
                  </p>
                </button>
                <button className="flex flex-col items-center justify-center border-b-[3px] border-b-transparent text-[#5d7589] pb-[13px] pt-4">
                  <p className="text-[#5d7589] text-sm font-bold leading-normal tracking-[0.015em]">
                    People
                  </p>
                </button>
...
export default CandidateCompanyJobs;
